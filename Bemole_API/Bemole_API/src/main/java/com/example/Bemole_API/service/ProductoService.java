...
public class ProductoService {
    ...
    private void validarProductoCompleto(Producto producto) {
        ...
        if (producto.getActivo() == null) {
            throw new IllegalArgumentException("El campo 'activo' del producto es obligatorio.");
        }
    ...
    private void validarPrecio(BigDecimal precio) {
        ...
        if (precio.compareTo(new BigDecimal("999999.99")) > 0) {
            throw new IllegalArgumentException("El precio excede el valor máximo permitido.");
        }
    }
